<div class="wpdevart-header-container">
    ...
    <div role="navigation" class="<?php if (get_theme_mod( 'wpdevart_car_rental_wda_header_show_action_button', '1' )) { echo esc_attr('nav-container-without-action-button'); } else { echo esc_attr('nav-container-layout-one'); } ?>">
    ...
    <?php if ( class_exists( 'WooCommerce' ) ) { ?>
            ...
            <div class="header-cart">
                <a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'car-rental-wda' ); ?>">
				...
				<?php wpdevart_car_rental_wda_header_cart_layout_one() ?>
            </div>   
    <?php } ?>
